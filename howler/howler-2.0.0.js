      ...
      var unlock = function() {
        ...
        setTimeout(function() {
          if ((source.playbackState === source.PLAYING_STATE || source.playbackState === source.FINISHED_STATE)) {
            ...
            Howler.iOSEnabled = true; //## DOPAMINE: used for detection
            
            // Remove the touch start listener.
            document.removeEventListener('touchend', unlock, false);  //## DOPAMINE: supports iOS9
          }
        }, 0);
      };

      // Setup a touch start listener to attempt an unlock in.
      document.addEventListener('touchend', unlock, false);  //## DOPAMINE: supports iOS9
